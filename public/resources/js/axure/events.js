...
$axure.internal(function($ax) {
    ...
    //for button shapes and img the img is focusable instead of the div to get better outlines
    ...
    var _initializeObjectEvents = function(query) {
        ...
        mouseFilter.bind($ax.features.eventNames.mouseDownName, function() {
            ...
            //there used to be something we needed to make img click, because swapping out the img prevents the click
